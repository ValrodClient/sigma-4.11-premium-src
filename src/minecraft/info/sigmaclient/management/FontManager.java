...
public class FontManager {
    ...
    public FontManager() {
        ...
        try {
            for (int i : new int[]{6, 7, 8, 10, 11, 12, 14, 47}) {
            ...
            for (int i : new int[]{6, 7, 8,9, 11, 47}) {
            ...
            for (int i : new int[]{6, 7, 8, 9, 11, 12, 47}) {
            ...
            for (int i : new int[]{17, 10, 9, 8, 7, 6, 47}) {
