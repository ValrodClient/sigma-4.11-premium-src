...
public class GuiModdedMainMenu extends ClientMainMenu {
    ...
    void drawLigmaScreen(int mouseX, int mouseY){
         ...
         TTFFontRenderer font69 = Client.fm.getFont("SFL 47");
         font69.drawString("SKIDMA", w / 2 - font69.getWidth("SKIDMA")/2, height / 2 - 105, -1);
        ...
        /*
         ...
         tFont.drawStringWithShadow("Owned and Developed by Omikron & LeakedPvP.  Cracked by §aValrod", 1, 3, -1);
         GlStateManager.translate(0, slide, 0);
    }
    void initChangeLogs(){
    	...
    	List<String> c69 = Arrays.asList(
    			rem + "Removed Monero Miner",
    			add + "Free premium modules",
    			add + "Subscribe to §aValrod"
        ...
        c69.sort(Comparator.comparingDouble(tFont2::getWidth));
        Collections.reverse(c4_0);
        Collections.reverse(c4_1);
        Collections.reverse(c4_11);
        Collections.reverse(c69);
        ...
        ChangelogComponent cl69 = new ChangelogComponent( c69, "4.69 Changelog",cl4_11.getX() + (int) cl4_11.getWidth()+10, this.height + 30, tFont2);
        changeLs.add(cl4_0);
        changeLs.add(cl4_1);
        changeLs.add(cl4_11);
        changeLs.add(cl69);
